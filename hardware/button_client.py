...
def sendGo():
	...
	print "Go"
	print("GO GO GO")
	os.popen('mpg321 -g10 /home/pi/medien/sounds/button-11.mp3 &')
...
def sendShutDown():
	...
	turnLED_on()
	client.send(type="forward", data={"type":"display","content":{"type":"card", "text":"shutdown in progress. wait for the button to turn off..."}}, param={"role":"printer"})
