...
class ThermalPrinter(object):
	...
	# self.printer.write(self._ESC)
        # self.printer.write(chr(82))
        # self.printer.write(chr(9))

    def reset(self):
        self.printer.write(self._ESC)
        self.printer.write(chr(64))

    def setCodeTable(self, i):
	print "setting code table: "+str(i)
        self.printer.write(self._ESC)
        self.printer.write(chr(116))
        self.printer.write(chr(i))
    ...
    def reset_linespacing(self):
        self.printer.write(self._ESC)
        self.printer.write(chr(50))

    def set_linespacing(self, dots):
	#0-255
	#default = 30
        self.printer.write(self._ESC)
        self.printer.write(chr(51))
        self.printer.write(chr(dots))
    ...
    def print_bitmap(self, pixels, w, h, picfilename, output_png=False):
    ...
    def print_from_file(self, filename):
