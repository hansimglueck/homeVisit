...
def replaceSpecialChars(txt):
	### The "Ø" and "ø" only work with Norwegian character set, setup in printer_gs.py
        specialChars = {'“':'\x22', '”':'\x22', '„':'\x22', '‟':'\x22', '«':'\xAE', '»':'\xAF', 'Ä':'\x8E', 'ä':'\x84', 'Ö':'\x99', 'ö':'\x94', 'Ü':'\x9A', 'ü':'\x81', 'ß':'\xE1', 'Ç':'\x80', 'ç':'\x87', 'É':'\x90', 'é':'\x82', 'Â':'\x83', 'â':'\x83', 'À':'\x85', 'à':'\x85', 'Å':'\x8F', 'å':'\x86', 'Ê':'\x88', 'ê':'\x88', 'Ë':'\x89', 'ë':'\x89', 'È':'\x8A', 'è':'\x8A', 'Ï':'\x8B', 'ï':'\x8B', 'Î':'\x8C', 'î':'\x8C', 'Ì':'\x8D', 'ì':'\x8D', 'Æ':'\x92', 'æ':'\x91', 'Ô':'\x93', 'ô':'\x93', 'Ò':'\x95', 'ò':'\x95', 'Û':'\x96', 'û':'\x96', 'Ù':'\x97', 'ù':'\x97', 'Á':'\xA0', 'á':'\xA0', 'Í':'\xA1', 'í':'\xA1', 'Ó':'\xA2', 'ó':'\xA2', 'Ú':'\xA3', 'ú':'\xA3', 'Ñ':'\xA5', 'ñ':'\xA4', '¡':'\xAD', '¿':'\xA8', '‹':'\x3C', '›':'\x3E', 'Ø':'\x5C', 'ø':'\x7c', '–':'-', 'Ą':'A', 'ą':'a', 'Ć':'C', 'ć':'c', 'Ę':'E', 'ę':'e', 'Ł':'L', 'ł':'l', 'Ń':'N', 'ń':'n', 'Ś':'S', 'ś':'s', 'Ź':'Z', 'ź':'z', 'Ż':'Z', 'ż':'z', 'Č':'C', 'č':'c', 'Ď':'D', 'ď':'d\'', 'ě':'e', 'Ň':'N', 'ň':'n', 'Ř':'R', 'ř':'r', 'Š':'S', 'š':'s', 'Ť':'T', 'ť':'t\'', 'Ů':'U', 'ů':'u', 'Ý':'Y', 'ý':'y', 'Ž':'Z', 'ž':'z', 'Ã':'\xC7', 'ã':'\xC6', 'Õ':'\xE5', 'õ':'\xE4', 'Œ':'OE', 'œ':'oe', 'Ÿ':'Y', 'ÿ':'y'}
