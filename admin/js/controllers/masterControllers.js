...
(function () {
    ...
    masterControllers.controller('GameConfCtrl', function ($scope, setFactory, itemOptions, GameConf, $filter, gettextCatalog, OtherLanguages) {
        ...
        $scope.removeDeviceFromType = function (typeId, devId) {
            ...
            $scope.updateGameConf({typeMapping: updatedTypeMapping}).then(function (x) {
