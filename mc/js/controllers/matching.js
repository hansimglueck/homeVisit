            ...
            for (var quest_index = 0; quest_index < Polls.polls.length; quest_index++) {
                ...
                if (questType === 'binary') {
                    if (Polls.polls[quest_index].answers[playerX] == Polls.polls[quest_index].answers[playerY] &&
                        Polls.polls[quest_index].answers[playerX] != -1 && Polls.polls[quest_index].answers[playerY] != -1) {
                    ...
                    if (Polls.polls[quest_index].answers[playerX] != -1 && Polls.polls[quest_index].answers[playerY] != -1) {
