(function() {
    ...
    var sessionRestriction = {$or:[{$and:[{$or:[{city:"Moskau"},{city:"St. Petersburg"},{city:"Yekaterinburg"},{city:/Russia/i}]},{date:{$gt:new Date(Date.now()-7*24*60*60*1000).toISOString()}}]}, {sessionId:1}]};
